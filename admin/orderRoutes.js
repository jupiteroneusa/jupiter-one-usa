  ...
  router.post('/orders/:id/generate-invoice', async (req, res) => {
    ...
    try {
      ...
      try {
        ...
        const mailOpts = { from: '"Jupiter One USA" <DTorchia@jupiteroneusa.com>', to: o.email, cc: adminCopy.toLowerCase() !== String(o.email).toLowerCase() ? adminCopy : undefined, bcc: 'DTorchia@jupiteroneusa.com', subject: (isPaidInFull ? 'PAID: Invoice ' : 'Invoice ')+invoiceNumber+' — Jupiter One USA', html: emailHtml };
