    ...
    try {
      ...
      if (activeTab === 'lines') {
        ...
        if (po.status === 'Draft') {
                  ...
                  html += '</div>';
                  html += '</form>';
                  // JS for + Add Line  (PO_EDIT_LINES_v2: clean DOM builder using window.__poLineIdx)
                  html += '<script>(function(){window.__poLineIdx=' + linesR.recordset.length + ';window.addPoLineRow=function(){var tb=document.getElementById("poLinesTbody");if(!tb)return;var tr=document.createElement("tr");tr.setAttribute("data-linerow","");tr.style.borderBottom="1px solid rgba(30,45,66,0.5)";var c1=document.createElement("td");c1.style.padding="6px";c1.appendChild(document.createTextNode("new"));var hid=document.createElement("input");hid.type="hidden";hid.name="line_"+window.__poLineIdx+"_id";hid.value="";c1.appendChild(hid);tr.appendChild(c1);var c2=document.createElement("td");c2.style.padding="6px";var sp=document.createElement("span");sp.style.color="#7a8a9a";sp.style.fontSize=".7rem";sp.style.fontStyle="italic";sp.appendChild(document.createTextNode("ad-hoc"));c2.appendChild(sp);tr.appendChild(c2);var c3=document.createElement("td");c3.style.padding="6px";var i3=document.createElement("input");i3.type="text";i3.name="line_"+window.__poLineIdx+"_item";i3.placeholder="e.g. 3.5% CC surcharge";i3.style.cssText="width:100%;background:#0a1628;border:1px solid #1e2d42;color:#eef1f5;padding:5px 8px;font-size:.78rem;";c3.appendChild(i3);tr.appendChild(c3);var c4=document.createElement("td");c4.style.padding="6px";c4.style.textAlign="center";var i4=document.createElement("input");i4.type="number";i4.name="line_"+window.__poLineIdx+"_qty";i4.min="1";i4.value="1";i4.style.cssText="width:70px;background:#0e1828;border:1px solid #1e2d42;color:#eef1f5;padding:5px 6px;font-size:.78rem;text-align:center;";c4.appendChild(i4);tr.appendChild(c4);var c5=document.createElement("td");c5.style.padding="6px";c5.style.textAlign="right";c5.appendChild(document.createTextNode("$"));var i5=document.createElement("input");i5.type="number";i5.step="0.01";i5.name="line_"+window.__poLineIdx+"_cost";i5.value="0.00";i5.style.cssText="width:100px;background:#0e1828;border:1px solid #1e2d42;color:#eef1f5;padding:5px 6px;font-size:.78rem;text-align:right;";c5.appendChild(i5);tr.appendChild(c5);var c6=document.createElement("td");c6.style.padding="6px";c6.style.textAlign="right";c6.style.color="#7a8a9a";c6.style.fontSize=".78rem";c6.appendChild(document.createTextNode("computed on save"));tr.appendChild(c6);var c7=document.createElement("td");c7.style.padding="6px";c7.style.textAlign="center";var rb=document.createElement("button");rb.type="button";rb.style.cssText="background:#3b1d1d;border:1px solid #5a2828;color:#e05050;padding:3px 8px;cursor:pointer;border-radius:3px;font-size:.7rem;";rb.innerHTML="\u2716";rb.onclick=function(){if(confirm("Remove this line?"))this.closest("[data-linerow]").remove();};c7.appendChild(rb);tr.appendChild(c7);tb.appendChild(tr);window.__poLineIdx++;};})();</script>'; // PO_EDIT_LINES_v2
