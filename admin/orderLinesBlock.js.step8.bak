...
export function renderLinesTab(o, oLines, suppliers) {
  let html = '';

  html += '<div class="card" style="margin-bottom:16px;"><div class="card-header">Order Line Items (' + oLines.recordset.length + ')</div>';
