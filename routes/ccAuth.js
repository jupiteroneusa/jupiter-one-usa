      ...
      <form method="POST" action="/cc-auth/\${esc(req.params.token)}" id="ccform" onsubmit="return prepareSubmit()">
        ...
        <div class="section">
          ...
          <div class="pci-notice">
            <strong>🔒 Secure:</strong> For your safety, we only store the LAST 4 DIGITS of your card. A Jupiter One USA representative will call you at the number on file to securely collect the full card number for processing.
          </div>
          <div class="grid">
