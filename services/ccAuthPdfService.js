...
export async function generateCcAuthPdf(authId) {
  ...
  doc.text('(347) 821-7412  ·  DTorchia@JupiterOneUSA.com', margin, y + 14);
  ...
  doc.setTextColor.apply(doc, midGray);
  doc.text(
    'This document was generated by Jupiter One USA admin system. For inquiries: DTorchia@JupiterOneUSA.com',
    pageW / 2,
    pageH - 8,
    { align: 'center' }
  );
